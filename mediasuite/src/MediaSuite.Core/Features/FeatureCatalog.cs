...
public static class FeatureCatalog
{
    private static readonly ImmutableArray<FeatureDescriptor> Features = ImmutableArray.Create(
        ...
        new FeatureDescriptor("image.webp-to-jpg", "WEBP to JPG", FeatureSection.Convert, "Image", "WebP to JPEG with a chosen quality preset.", 4),
        ...
        new FeatureDescriptor("gif.compress", "GIF Compressor", FeatureSection.Compress, "GIF", "Fewer colours and a lower frame rate to shrink the file.", 6),
        new FeatureDescriptor("video.crop", "Crop Video", FeatureSection.Tools, "Video Tools", "Crop to a region by pixel coordinates and size.", 5),
        ...
        new FeatureDescriptor("pdf.merge", "PDF Merge", FeatureSection.Tools, "PDF Tools", "Combine PDFs in the order you add them.", 7),
        ...
        new FeatureDescriptor("pdf.crop", "Crop PDF", FeatureSection.Tools, "PDF Tools", "Trim the same margin off every page.", 7),
        new FeatureDescriptor("pdf.organize", "Organize PDF", FeatureSection.Tools, "PDF Tools", "Reorder, duplicate and delete pages by typing the page list you want.", 7),
