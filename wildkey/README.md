...
- **Identify queue** (`/identify`): a real agree/skip card queue over mock pending IDs, with CV confidence and observer/place context, ending in a completion summary.
