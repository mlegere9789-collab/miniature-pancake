...
s2check "Snapshots: saved model states are planned" "Snapshots"
...
s2check "Worksession: reference models are planned" "Worksession"
s2check "LimitReferenceModel: reference models are planned" "LimitReferenceModel"
